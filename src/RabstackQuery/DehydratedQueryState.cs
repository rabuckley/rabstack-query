...
/// <summary>
/// Non-generic mirror of <see cref="QueryState{TData}"/> for serialization.
/// Data is stored as <c>object?</c> to avoid type parameters at the
/// dehydration boundary.
/// </summary>
public sealed class DehydratedQueryState
{
